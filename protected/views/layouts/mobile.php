...
<head>
	...
	<!--link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/turbine/css.php?files=default.cssp;form.cssp" /-->
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/default_.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/menu_.css" />
...
<div id="mainmenu"><a id="logo" href="index.php"><img src="images/jseeker.png"/></a>
    <?php $this->widget('zii.widgets.CMenu',array(
            'items'=>array(
                    ...
                    array('url'=>Yii::app()->getModule('job')->viewJobPosts, 'label'=>'Jobs', 'visible'=>!Yii::app()->user->isGuest, 'linkOptions' => array('class'=>'jsmen arw'),
                        'items'=>array(
                            array('url'=>Yii::app()->getModule('job')->viewMyJobPosts, 'label'=>'View Jobs', 'visible'=>!Yii::app()->user->isGuest),
                            //array('url'=>Yii::app()->getModule('job')->viewJobPosts, 'label'=>'View Posts', 'visible'=>!Yii::app()->user->isGuest),
                            array('url'=>Yii::app()->getModule('job')->createJobPost, 'label'=>'Create Job', 'visible'=>!Yii::app()->user->isGuest),
                            array('url'=>Yii::app()->getModule('job')->jobsForMe, 'label'=>'Jobs -Your Skills', 'visible'=>!Yii::app()->user->isGuest),
                        ),
                    ),
