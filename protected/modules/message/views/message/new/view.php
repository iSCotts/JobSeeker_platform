...
<h2><?php echo GxHtml::encode($model->getRelationLabel('responses')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->responses as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('response/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
