...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="row submit">
		<?php echo CHtml::submitButton(UserModule::t("Login")); ?> <?php echo CHtml::link(UserModule::t("Forgot your password?"),Yii::app()->getModule('user')->recoveryUrl); ?>
	</div>
	
	<div class="row">
		<p class="hint">Do you have an account?
