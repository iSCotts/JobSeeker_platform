...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'notification_type_id'); ?>
		<?php echo $form->dropDownList($model, 'notification_type_id', GxHtml::listDataEx(NotificationType::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
